...
\begin{tabularx}{270mm}{>{\ttfamily}llXX}
\toprule
\multicolumn{4}{l}{\Huge Points-only; predicate symbols on comparison of angles} \\ \midrule
ADGLib & 
\LaTeX{} notation & 
Intuitive meaning & 
Definition \\ \midrule
...
fun\_symmetric(P,O) & 
&
the asymmetric of $P$ wrt. $O$. \\
%-------------------------------------------------------------------
fun\_symmetric(P,A,B) & 
&
the asymmetric of $P$ wrt. line $AB$. \\
%-------------------------------------------------------------------
fun\_incenter(A,B,C) & 
&
...
%-------------------------------------------------------------------
fun\_intersection\_ll(A,B,C,D) & 
&
intersection of lines AB and CD (assuming they do interesect ? ) \\
%-------------------------------------------------------------------
fun\_intersection\_ls(A,B,C,D) & 
&
