...
%-------------------------------------------------------------------
intersection\_circles(P,Q,O,P,O',P') & 
& 
...
&
the intersection of lines AB and CD (assuming they do interesect ? ) \\
%-------------------------------------------------------------------
...
\begin{tabularx}{270mm}{>{\ttfamily}llXX}
\toprule
\multicolumn{4}{l}{\Huge Area method; function symbols} \\ \midrule
ADGLib & 
\LaTeX{} notation & 
Intuitive meaning & 
Definition \\ \midrule
signed\_area(A,B,C) & & the signed area of triangle $ABC$ & \\
signed\_ratio(A,B,C,D) & & the ratio of the signed distance from $A$ to $B$ and from $C$ to $D$ \\
pythagoras\_difference(A,B,C) & & $AB^2 + BC^2 - AC^2$ \\
\bottomrule
\end{tabularx}
