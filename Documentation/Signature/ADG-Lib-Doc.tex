...
The {\em core} predicate symbols has to be supported by any translation and here
they are given in bold face.
...
%-------------------------------------------------------------------
{\bf congruent\_angles(A,B,C,D,E,F)} & 
$ \conga{A}{B}{C}{D}{E}{F} $ & 
...
%-------------------------------------------------------------------
{\bf congruent\_triangles(A,B,C,A',B',C')} & 
& 
...
$A \neq B \land C \neq B \land P \neq B \land \exists X, \bT{A}{X}{C} \land$ \\
 & & & $ (X = B \lor \out{B}{X}{P}) $ \\
%-------------------------------------------------------------------
{\bf intersection\_line\_line(X,A,B,C,D)} & &
...
%-------------------------------------------------------------------
{\bf intersection\_line\_circle(X,Y,A,B,O,P)} & &
...
%-------------------------------------------------------------------
{\bf intersection\_circle\_circle(X,Y,O,P,O',P')} & 
& 
...
%-------------------------------------------------------------------
{\bf on\_angle\_bisector(P,A,O,B)} &  
& 
...
%-------------------------------------------------------------------
\addlinespace
{\bf on\_parallel(P,B,C,D)} & 
 & 
$P$ is on the parallel to line $CD$ through $B$ & 
$ \para{A B}{C D} \land C \neq D $ \\
%-------------------------------------------------------------------
{\bf on\_perpendicular\_bisector(P,A,B)} &  
& 
...
Definition \\ \midrule
%-------------------------------------------------------------------
{\bf perpendicular\_bisector(P,Q,A,B)} & 
& 
