...
\toprule
\multicolumn{4}{l}{\Huge Points-only; predicate symbols (1/3)} \\ \midrule
ADGLib & 
\LaTeX{} notation & 
Intuitive meaning & 
Definition \\ \midrule
...
%-------------------------------------------------------------------
gravity\_center(H,A,B,C) & 
& 
$H$ is the gravity center of triangle $ABC$. \\

%-------------------------------------------------------------------
on\_line\_harmonic(A,B,C,D) & 
& 
...
& 
$C$ is inside or on circle (or sphere) of center $O$ going through $P$.\\
%-------------------------------------------------------------------
inside\_circle\_strict(C,O,P) & 
& 
$C$ is strictly inside the circle (or sphere) of center $O$ going through $P$.\\
%-------------------------------------------------------------------
...
\begin{tabularx}{270mm}{>{\ttfamily}llXX}
\toprule
\multicolumn{4}{l}{\Huge Points-only; predicate symbols (2/3)} \\ \midrule
ADGLib & 
\LaTeX{} notation & 
Intuitive meaning & 
Definition \\ \midrule
...
%-------------------------------------------------------------------
intersection\_circle\_circle(P,Q,O,P,O',P') & 
& 
$P$ and $Q$ are the intersections of circles $OP$ and $O'P'$. \\
%-------------------------------------------------------------------
isosceles(A,B,C) & 
& 
...
%-------------------------------------------------------------------
on\_segment\_bisector(P,A,B) &  
& 
$P$ belongs to the bisector of segment $AB$ & 
$P \neq midpoint(A,B) \land AP$ and $PB$ are congruent \\
%-------------------------------------------------------------------
...
%-------------------------------------------------------------------
is\_intersection\_line\_line(P,A,B,C,D) & &
P is the intersection of lines $AB$ and $CD$ \\
%-------------------------------------------------------------------
is\_intersection\_line\_segment(P,A,B,C,D) & &
P is the intersection of line $AB$ and segment $CD$ \\
%-------------------------------------------------------------------
is\_intersection\_segment\_segment(P,A,B,C,D) & &
P is the intersection of segments $AB$ and $CD$ \\
%-------------------------------------------------------------------
...
\begin{tabularx}{270mm}{>{\ttfamily}llXX}
\toprule
\multicolumn{4}{l}{\Huge Points-only; predicate symbols (3/3)} \\ \midrule
ADGLib & 
\LaTeX{} notation & 
Intuitive meaning & 
Definition \\ \midrule
...
%-------------------------------------------------------------------
fun\_gravitycenter(A,B,C) & 
&
the gravitycenter of triangle $ABC$ \\
%-------------------------------------------------------------------
...
%-------------------------------------------------------------------
fun\_intersection\_circle\_segment(O,P,A,B) & 
&
intersection of circle of center $O$ going through $P$ and segment $AB$. \jn{what to do when there are two intersections ?} \\
\bottomrule
\end{tabularx}
